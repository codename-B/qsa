...
Round trip test for qsa.h, pinned to the QSA1 reference encoder
(GBVideo's tools/qav2_encode.c, whose bitstream is identical apart
...
qsa.h no longer agrees with the format.
